  ...
  const nextSteps = [
    {
      ...
      description: "Busca un email de confirmación con el asunto 'Bienvenida a Rhizea'. Si no lo ves en tu bandeja principal, revisa la carpeta de Spam o Promociones.",
      icon: Mail,
    },
    {
      number: "2",
